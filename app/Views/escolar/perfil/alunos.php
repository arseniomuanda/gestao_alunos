     ...
     <div class="pagetitle">
         ...
         <nav>
             <ol class="breadcrumb">
                 ...
                 <li v-if="acesso == 1" class="breadcrumb-item"><a href="/escolar/alunos">Alunos</a></li>
                 <li class="breadcrumb-item active"><?= $aluno->nome ?></li>
             </ol>
         </nav>
     </div><!-- End Page Title -->
                 ...
                 <div class="card">
                     <div class="card-body pt-3">
                         ...
                         <div class="tab-content pt-2">
                             ...
                             <div v-if="acesso == 1 || acesso == 3" class="tab-pane fade profile-edit pt-3" id="profile-edit">
                             ...
                             <div v-if="acesso == 1" class="tab-pane fade pt-3" id="profile-settings">
                                 <!-- Settings Form -->
                             ...
                             <div v-if="acesso == 1" class="tab-pane fade pt-3" id="profile-options">
