             ...
             <div class="col-xl-4">
                 ...
                 <div class="card">
                     <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                         ...
                         <img src="<?= $utilizador->foto ?>" alt="Profile" class="rounded-circle">
                         ...
                         <div class="tab-content pt-2">
                             ...
                             <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-lg-9 col-md-8"><?= $utilizador->nome ?></div>
                                 </div>

                                 <div class="row">
                                     <div class="col-lg-3 col-md-4 label ">BI</div>
                                     <div class="col-lg-9 col-md-8"><?= $utilizador->bi ?></div>
                                 </div>

                                 <div class="row">
                                     <div class="col-lg-3 col-md-4 label ">Sexo</div>
                                     <div class="col-lg-9 col-md-8"><?= $utilizador->sexo ?></div>
                                 </div>
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-lg-9 col-md-8"><?= $utilizador->municipio ?>, <?= $utilizador->bairro ?></div>
                                 </div>
                             ...
                             <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                 ...
                                 <!-- Profile Edit Form -->
                                 <form onsubmit="event.preventDefault();vue_app.editutilizador(<?= $utilizador->id ?>)">
                                     <div class="row mb-3">
                                         <label for="nome" class="col-md-4 col-lg-3 col-form-label">Nome Completo</label>
                                         <div class="col-md-8 col-lg-9">
                                             <input name="nome" type="text" required class="form-control" id="nome" value="<?= $utilizador->nome ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input type="text" required class="form-control" name="bi" id="bi" value="<?= $utilizador->bi ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="email" required type="email" class="form-control" id="email" value="<?= $utilizador->email ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="telefone" required type="text" class="form-control" id="telefone" value="<?= $utilizador->telefone ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="municipio" type="text" class="form-control" id="municipio" value="<?= $utilizador->municipio ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="bairro" type="text" class="form-control" id="bairro" value="<?= $utilizador->bairro ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="rua" type="text" class="form-control" id="rua" value="<?= $utilizador->rua ?>">
                                         </div>
                                     </div>
                                     ...
                                     <div class="row mb-3">
                                         ...
                                         <div class="col-md-8 col-lg-9">
                                             <input name="n_casa" type="text" class="form-control" id="n_casa" value="<?= $utilizador->n_casa ?>">
                                         </div>
                                     </div>
                             ...
                             <div class="tab-pane fade pt-3" id="profile-change-password">
                                 ...
                                 <form onsubmit="event.preventDefault();vue_app.editPass(<?= $utilizador->id ?>)">
                                     ...
                                     <div class="text-center">
                                         <button type="submit" class="btn btn-primary">Salvar</button>
                                         <button type="button" onclick="vue_app.resetPass(<?= $utilizador->id ?>)" class="btn btn-danger"><i class="bi bi-unlock"></i> Reset Password</button>
                                     </div>
